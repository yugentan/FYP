...
public class t3large implements INode {
    private Host host;
    private int id;
    //Characteristics of t3.large
    private static final String VM_TYPE = "t3.large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 8000; // RAM: large instance have 8 GiB ram
    ...
    private static final double VM_COST = 0.08; //Cost: on demand cost for large instance
    public t3large(int id){
        this.id = id;
    }
