...
public class c5x12large implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.x12large
    private static final String VM_TYPE = "c5.x12large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 96000; // RAM: x12large instance have 1 GiB ram
    ...
    private static final double VM_COST = 2.04; //Cost: on demand cost for x12large instance
    public c5x12large(int id){
        this.id = id;
    }
