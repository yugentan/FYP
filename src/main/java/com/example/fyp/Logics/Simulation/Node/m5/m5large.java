...
public class m5large implements INode {
    private Host host;
    private int id;
    //Characteristics of m5.large
    private static final String VM_TYPE = "m5.large";
    ...
    private static final double VM_COST = 0.1; //Cost: on demand cost for large instance
    public m5large(int id){
        this.id = id;
    }
