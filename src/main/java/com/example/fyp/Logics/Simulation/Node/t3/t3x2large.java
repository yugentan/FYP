...
public class t3x2large implements INode {
    private Host host;
    private int id;
    //Characteristics of t3.x2large
    private static final String VM_TYPE = "t3.x2large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 32000; // RAM: x2large instance have 8 GiB ram
    ...
    private static final double VM_COST = 0.33; //Cost: on demand cost for x2large instance
    public t3x2large(int id){
        this.id = id;
    }
