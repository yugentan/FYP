...
public class t3micro implements INode {
    private Host host;
    private int id;
    //Characteristics of t3.micro
    private static final String VM_TYPE = "t3.micro";
    ...
    private static final int VM_PES = 2; //Number of Processing Elements (cores): micro instance have 2CPU
