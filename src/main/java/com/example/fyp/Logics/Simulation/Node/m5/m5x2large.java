...
public class m5x2large implements INode {
    private Host host;
    private int id;
    //Characteristics of m5.x2large
    private static final String VM_TYPE = "m5.x2large";
    ...
    private static final double VM_COST = 0.38; //Cost: on demand cost for x2large instance
    public m5x2large(int id){
        this.id = id;
    }
