...
public class t2medium implements INode {
    private Host host;
    private int id;
    //Characteristics of t2.medium
    private static final String VM_TYPE = "t2.medium";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 4000; // RAM: medium instance have 1 GiB ram
    ...
    private static final double VM_COST = 0.05; //Cost: on demand cost for medium instance
    public t2medium(int id){
        this.id = id;
    }
