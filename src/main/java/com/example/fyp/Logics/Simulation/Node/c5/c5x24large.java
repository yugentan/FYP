...
public class c5x24large implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.x24large
    private static final String VM_TYPE = "c5.x24large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 192000; // RAM: x24large instance have 1 GiB ram
    ...
    private static final double VM_COST = 4.08; //Cost: on demand cost for x24large instance
    public c5x24large(int id){
        this.id = id;
    }
