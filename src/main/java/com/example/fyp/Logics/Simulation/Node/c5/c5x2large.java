...
public class c5x2large implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.x2large
    private static final String VM_TYPE = "c5.x2large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 16000; // RAM: x2large instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: x2large instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 8; //Number of Processing Elements (cores): x2large instance have 2 CPU
    ...
    private static final double VM_COST = 0.34; //Cost: on demand cost for x2large instance
    public c5x2large(int id){
        this.id = id;
    }
