...
public class m5x12large implements INode {
    private Host host;
    private int id;
    //Characteristics of m5.x12large
    private static final String VM_TYPE = "m5.x12large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 192000; // RAM: x12large instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: x12large instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 48; //Number of Processing Elements (cores): x12large instance have 2 CPU

    private static final int VM_SIZE = 10000; //Storage in Mb: x12large instance does not come with storage, default of 10000Mb is used

    private static final double VM_COST = 2.3; //Cost: on demand cost for x12large instance
    public m5x12large(int id){
        this.id = id;
    }
