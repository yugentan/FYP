...
public class c5xlarge implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.xlarge
    private static final String VM_TYPE = "c5.xlarge";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 8000; // RAM: xlarge instance have 1 GiB ram
