...
public class t2small implements INode {
    private Host host;
    private int id;
    //Characteristics of t2.small
    private static final String VM_TYPE = "t2.small";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 2000; // RAM: small instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: small instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 1; //Number of Processing Elements (cores): small instance have 1vCPU
