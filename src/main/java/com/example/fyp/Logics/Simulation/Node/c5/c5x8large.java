...
public class c5x8large implements INode {

    private Host host;
    private int id;
    //Characteristics of c5.x8large
    private static final String VM_TYPE = "c5.x8large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 72000; // RAM: x8large instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: x8large instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 36; //Number of Processing Elements (cores): x8large instance have 2 CPU
    ...
    private static final double VM_COST = 1.53; //Cost: on demand cost for x8large instance
    public c5x8large(int id){
        this.id = id;
    }
