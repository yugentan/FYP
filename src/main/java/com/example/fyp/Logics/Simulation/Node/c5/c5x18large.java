...
public class c5x18large implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.x18large
    private static final String VM_TYPE = "c5.x18large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 144000; // RAM: x18large instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: x18large instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 72; //Number of Processing Elements (cores): x18large instance have 2 CPU

    private static final int VM_SIZE = 10000; //Storage in Mb: x18large instance does not come with storage, default of 10000Mb is used

    private static final double VM_COST = 3.06; //Cost: on demand cost for x18large instance
    public c5x18large(int id){
        this.id = id;
    }
