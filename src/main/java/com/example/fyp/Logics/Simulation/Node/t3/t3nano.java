...
public class t3nano implements INode {
    private Host host;
    private int id;
    //Characteristics of t3.nano
    private static final String VM_TYPE = "t3.nano";
    ...
    private static final int VM_PES = 2; //Number of Processing Elements (cores): nano instance have 1vCPU
