...
public class c5large implements INode {
    private Host host;
    private int id;
    //Characteristics of c5.large
    private static final String VM_TYPE = "c5.large";
    private static final int VM_MIPS = 1000; // (Millions Instruction per Second) Not disclosed, using default of 1000
    private static final int VM_RAM = 4000; // RAM: large instance have 1 GiB ram
    private static final int VM_BANDWIDTH = 100; // Bandwidth: large instance have low(100mb) - moderate(1000mb) bandwidth
    private static final int VM_PES = 2; //Number of Processing Elements (cores): large instance have 2 CPU
